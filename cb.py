...
def create_accumulated_rain_plot_with_provinces_and_sea(ds, shp_provinces, shp_sea, forecast_day, timesteps, start_time=None):
   ...
   logo = plt.imread('/home/wrf/arif/BMKG.png')
   logo_ax.imshow(logo)
   logo_ax.axis('off')
...
if __name__ == "__main__":
   shp_provinces = "/home/wrf/arif/datadasar/Provinsi.shp"
   shp_sea = "/home/wrf/arif/datadasar/Laut.shp"
   
   # Dapatkan waktu inisial dan timesteps
   selected_date, selected_hour, timesteps = get_initial_time()
   selected_days = 7
   
   print(f"\nMenggunakan data GFS tanggal {selected_date} jam {selected_hour}Z")
